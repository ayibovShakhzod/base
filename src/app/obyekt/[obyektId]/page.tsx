          ...
          <div className="flex gap-10 justify-between">
            <div className="flex flex-col">
              ...
              <p className="text-sm text-muted-foreground mt-1 max-w-3xl">
                ...
                consectetur laborum amet eius, temporibus natus culpa assumenda modi eum itaque quidem minus id aliquid
                distinctio. Nihil deleniti unde architecto voluptas.
              </p>
            </div>
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button variant="outline" className="rounded-full gap-1" size="icon">
                      <Pencil size="18" />
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent>
